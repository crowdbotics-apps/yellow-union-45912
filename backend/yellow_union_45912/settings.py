"""
Django settings for yellow_union_45912 project.
...
ROOT_URLCONF = 'yellow_union_45912.urls'
...
WSGI_APPLICATION = 'yellow_union_45912.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yellow_union_45912 API",
    "DESCRIPTION": "API documentation for yellow_union_45912 App",
    "VERSION": "v1",
}
